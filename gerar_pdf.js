      ...
      <table class="arch-table">
        ...
        <tbody>
          <tr>
            ...
            <td><em>"Olá! Vim pelo início do site da Janeiro Advocacia e gostaria de tirar uma dúvida sobre meus direitos previdenciários."</em></td>
          </tr>
          <tr>
            <td><strong>Identificação de Dores</strong></td>
            <td>Card Benefício Negado</td>
            <td><em>"Olá! Tive meu auxílio ou benefício negado pelo INSS e gostaria de entender como recorrer."</em></td>
          </tr>
          <tr>
            <td><strong>Áreas de Atuação</strong></td>
            <td>Modal Planejamento</td>
            <td><em>"Olá! Gostaria de agendar uma consulta sobre Planejamento Previdenciário para analisar meu CNIS e aposentadoria futura."</em></td>
          </tr>
          <tr>
            <td><strong>Áreas de Atuação</strong></td>
            <td>Modal Incapacidade</td>
            <td><em>"Olá! Gostaria de saber mais sobre o auxílio por incapacidade temporária (auxílio-doença) ou aposentadoria por invalidez."</em></td>
          </tr>
          <tr>
            <td><strong>Quiz Interativo</strong></td>
            <td>Resultado da Etapa 3</td>
            <td><em>"Olá! Acabei de fazer a autoavaliação no site da Janeiro Advocacia. Meu perfil é [Trabalhador CLT], meu principal objetivo é [Planejamento Previdenciário] e tenho [Mais de 25 anos] de contribuição."</em></td>
          </tr>
          <tr>
            <td><strong>Artigo Transição</strong></td>
            <td>Banner do Artigo 1</td>
            <td><em>"Olá! Li o artigo sobre as Regras de Transição da Aposentadoria no site de vocês e gostaria de uma análise sobre a melhor regra para o meu caso."</em></td>
          </tr>
          <tr>
            <td><strong>Artigo Auxílio Negado</strong></td>
            <td>Banner do Artigo 3</td>
            <td><em>"Olá! Li o artigo sobre Benefício Negado no INSS e preciso de ajuda com laudos e recurso judicial urgente."</em></td>
          </tr>
          <tr>
            <td><strong>Botão Flutuante</strong></td>
            <td>Ícone Canto Inferior</td>
            <td><em>"Olá! Estava navegando no site da Janeiro Advocacia e gostaria de uma orientação previdenciária."</em></td>
          </tr>
        </tbody>
      </table>
    </div>
